...
class GovernanceService:
    ...
    def records(self,cutoff_utc):
        ...
        # Blocked analyses retain null artifact IDs in immutable source evidence.
        # Governance groups them under UNKNOWN, including subsequent scope lookups.
        values=[]
