...
class LabLaunchService:
    ...
    def authorize(self, approval_id: str, operator: str, confirmation: str, *, authorized_at_utc: datetime, expires_at_utc: datetime, champion_generation_id: str, calibration_artifact_id: str, reasoning_policy_version: str = "goalvision-prediction-reasoning-policy-v1") -> dict:
        ...
        material = {"schema_version": "goalvision-first-lab-launch-authorization-v1", "approval_id": approval_id, "environment": "LAB", "chat_id": LAB_CHAT_ID, "bot_username": LAB_BOT, "governance_policy_fingerprint": DEFAULT_POLICY.fingerprint, "reasoning_policy_version": reasoning_policy_version, "publication_policy_version": "goalvision-lab-single-publication-v1", "live_model_schema_fingerprint": LIVE_MODEL_INPUT_CONTRACT.schema_fingerprint, "champion_generation_id": champion_generation_id, "calibration_artifact_id": calibration_artifact_id, "evidence_tier": "FORWARD_TEST_REAL_TIME", "allowed_markets": ALLOWED_MARKETS, "single_bets_only": True, "minimum_decimal_odds": "1.60", "correct_score_allowed": False, "combo_allowed": False, "publication_capacity": 1, "operator_identity": operator, "authorized_at_utc": authorized.isoformat(), "expires_at_utc": expires.isoformat()}
